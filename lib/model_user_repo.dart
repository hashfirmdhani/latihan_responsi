class UserRepoModel {
  ...
  UserRepoModel(this.items);

  UserRepoModel.fromJson(List json) {
    if (json!= null) {
      items = [];
      json.forEach((v) {
        items!.add(new data.fromJson(v));
      });
    }
  }
